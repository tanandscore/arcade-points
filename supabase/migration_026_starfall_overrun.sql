-- ============================================================
-- Migration: Starfall Overrun — a second horde-survival roguelite
-- for Legend Pass, mechanically distinct from Bloodmoon Siege (an
-- orbiting blade + periodic Pulse Nova instead of ranged auto-fire).
-- Original sci-fi theme and roster. Run once in Supabase SQL Editor
-- after migration_025.
-- ============================================================
...
values
  ('starfalloverrun', 'Starfall Overrun', '☄️', 'Legend Pass', '#b45cff', 'An orbiting blade, a Pulse Nova, and an endless void swarm. Survive the drop.', 'starfalloverrun', 'subscription', 'premium_plus', null, null, 230, true)
