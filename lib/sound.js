...
export const sfx = {
  ...
  pistolShot: () => tone({ frequency: 900, duration: 0.07, type: "square", glideTo: 320, volume: 0.17 }),
  smgShot: () => tone({ frequency: 480, duration: 0.045, type: "sawtooth", glideTo: 200, volume: 0.11 }),
  rifleShot: () => tone({ frequency: 220, duration: 0.09, type: "square", glideTo: 75, volume: 0.2, layered: true }),
