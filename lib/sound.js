...
const MAP_INTRO_STINGERS = {
  substation: [{ frequency: 220, duration: 0.18, type: "square" }, { frequency: 277, duration: 0.18, type: "square" }, { frequency: 330, duration: 0.4, type: "square", layered: true }],
  refinery: [{ frequency: 165, duration: 0.22, type: "sawtooth" }, { frequency: 196, duration: 0.22, type: "sawtooth" }, { frequency: 247, duration: 0.45, type: "sawtooth", layered: true }],
  undercroft: [{ frequency: 196, duration: 0.14, type: "triangle" }, { frequency: 233, duration: 0.14, type: "triangle" }, { frequency: 196, duration: 0.14, type: "triangle" }, { frequency: 311, duration: 0.35, type: "triangle", layered: true }],
  skybridge: [{ frequency: 262, duration: 0.2, type: "sine" }, { frequency: 330, duration: 0.2, type: "sine" }, { frequency: 392, duration: 0.4, type: "sine", layered: true }],
  frostline: [{ frequency: 294, duration: 0.25, type: "sine" }, { frequency: 349, duration: 0.25, type: "sine" }, { frequency: 440, duration: 0.5, type: "sine", layered: true }],
  signalhill: [{ frequency: 220, duration: 0.16, type: "square" }, { frequency: 294, duration: 0.16, type: "square" }, { frequency: 349, duration: 0.16, type: "square" }, { frequency: 440, duration: 0.4, type: "square", layered: true }],
};

export function playMapIntro(mapId) {
  sequence(MAP_INTRO_STINGERS[mapId] || MAP_INTRO_STINGERS.substation);
}
