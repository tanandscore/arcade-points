...
// --- Shadowfall's roster — atmospheric, muted dark-fantasy ---
const WANDERER_SPRITE = {
  palette: { c: "#3a3a4a", d: "#1a1a26", e: "#3ee6e0", s: "#e8e2d6" },
  grid: [
    " cccc ",
    "cdcccd",
    "cscscs",
...
const HUSKCRAWLER_SPRITE = {
  palette: { h: "#8a6a3c", d: "#4a3a1c", e: "#ff3ea5" },
  grid: [
    "h    h",
    "hh  hh",
    "hehhehh",
...
const WISPDRIFTER_SPRITE = {
  palette: { w: "#3ee6e0", e: "#ffe14d" },
  grid: [
    "  w  ",
    " www ",
    "wewew",
...
const HOLLOW_WARDEN_SPRITE = {
  palette: { p: "#2a1a40", a: "#ff3ea5", e: "#ffe14d", d: "#1a0f2a" },
  grid: [
    " ppppppp ",
    "ppdpppdpp",
    "peapppaep",
...
// --- Driftlight's roster — the one non-hostile spectacle creature ---
const COLOSSUS_SPRITE = {
  palette: { m: "#3ee6e0", d: "#1a4a48", e: "#ffe14d", g: "#e8e2d6" },
  grid: [
    "  mm    mm  ",
    " mmmm  mmmm ",
    "mmmmmmmmmmmm",
...
export const SPRITES = {
  ...
  wanderer: WANDERER_SPRITE,
  huskcrawler: HUSKCRAWLER_SPRITE,
  wispdrifter: WISPDRIFTER_SPRITE,
  hollowwarden: HOLLOW_WARDEN_SPRITE,
  colossus: COLOSSUS_SPRITE,
};
