...
// 9 different mechanical "kinds" are used across the roster), its
// own combat sound voice (base frequency + waveform + glide
// direction), and its own AI personality (aggression, how often it
// blocks, how eagerly it reaches for its specials) — so an AI Kael
// genuinely plays differently from an AI Terra, not just different
// numbers on the same generic script.
export const ROSTER = [
  {
    id: "kael",
    name: "Kael Ashborn",
    ...
    aiPersonality: { aggression: 0.85, blockChance: 0.15, specialEagerness: 0.4 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.4, blockChance: 0.55, specialEagerness: 0.3 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.75, blockChance: 0.2, specialEagerness: 0.45 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.3, blockChance: 0.6, specialEagerness: 0.25 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.7, blockChance: 0.2, specialEagerness: 0.5 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.65, blockChance: 0.25, specialEagerness: 0.55 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.5, blockChance: 0.4, specialEagerness: 0.35 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.35, blockChance: 0.65, specialEagerness: 0.3 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.55, blockChance: 0.35, specialEagerness: 0.5 },
    specials: [
  ...
  },
  {
    ...
    aiPersonality: { aggression: 0.5, blockChance: 0.45, specialEagerness: 0.4 },
    specials: [
