...
// Same lazy-init pattern as lib/razorpay.js, for the same reason:
// built only when actually needed inside a request, not at import
// time, since Cloudflare's build step doesn't have secret env vars
