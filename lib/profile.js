...
import { getLeaderboardRows, HALL_OF_FAME_THRESHOLD } from "@/lib/leaderboard";
...
export async function getPublicProfile(username) {
  ...
  const [{ data: scoreRows }, { data: recentRows }, overallRows, streakDays, activeSeason] = await Promise.all([
  ...
  return {
    ...
    overallRank: rankIndex >= 0 ? rankIndex + 1 : null,
