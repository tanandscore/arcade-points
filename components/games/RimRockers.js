...
const DIFFICULTY = {
  1: { label: "CADET", mult: 1, defenderSpeed: 0.35, meterSpeed: 3.6, tolerance: 72 },
  2: { label: "EASY", mult: 1.2, defenderSpeed: 0.5, meterSpeed: 4.5, tolerance: 78 },
  3: { label: "MEDIUM", mult: 1.45, defenderSpeed: 0.68, meterSpeed: 5.2, tolerance: 82 },
  4: { label: "HARD", mult: 1.75, defenderSpeed: 0.85, meterSpeed: 6, tolerance: 86 },
  5: { label: "ACE", mult: 2.1, defenderSpeed: 1.0, meterSpeed: 6.8, tolerance: 89 },
  6: { label: "LEGEND", mult: 2.5, defenderSpeed: 1.2, meterSpeed: 7.8, tolerance: 92 },
};
