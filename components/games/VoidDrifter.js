...
const TICK_MS = 45;
const DIFFICULTY = {
  1: { label: "CADET", mult: 1, spawnEvery: 115, maxCount: 5, startCount: 2, speedMult: 0.85 },
  2: { label: "EASY", mult: 1.2, spawnEvery: 95, maxCount: 6, startCount: 3, speedMult: 1 },
  3: { label: "MEDIUM", mult: 1.45, spawnEvery: 78, maxCount: 8, startCount: 4, speedMult: 1.2 },
  4: { label: "HARD", mult: 1.75, spawnEvery: 62, maxCount: 10, startCount: 5, speedMult: 1.4 },
  5: { label: "ACE", mult: 2.1, spawnEvery: 48, maxCount: 12, startCount: 6, speedMult: 1.6 },
  6: { label: "LEGEND", mult: 2.5, spawnEvery: 36, maxCount: 15, startCount: 7, speedMult: 1.85 },
};
