...
const CORNER_STRESS_LIMIT = 1.15;
const OFF_TRACK_MARGIN = TRACK_WIDTH / 2 - 0.4;
...
export default function ApexCircuit({ onFinish, accentColor }) {
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      const turnRate = 0.05 - speedRatio * 0.022;
      ...
      if (cornerStress > CORNER_STRESS_LIMIT) {
        moveSpeed *= 0.5;
        s.heading += (Math.random() - 0.5) * 0.08;
      }
