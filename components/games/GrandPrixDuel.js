...
const AI_DIFFICULTY = {
  1: { label: "ROOKIE", mult: 1, topSpeedMult: 0.62, cornerSpeedMult: 1.25, smoothing: 0.025 },
  2: { label: "AMATEUR", mult: 1.3, topSpeedMult: 0.76, cornerSpeedMult: 1.35, smoothing: 0.033 },
  3: { label: "PRO", mult: 1.6, topSpeedMult: 0.9, cornerSpeedMult: 1.45, smoothing: 0.045 },
  4: { label: "LEGEND", mult: 2, topSpeedMult: 1.03, cornerSpeedMult: 1.55, smoothing: 0.06 },
};
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-2 gap-2 max-w-[280px] mx-auto">
          {[1, 2, 3, 4].map((lvl) => (
            ...
            >
              LVL {lvl}
              <div className="text-[8px] text-textDim mt-1">{AI_DIFFICULTY[lvl].label} ×{AI_DIFFICULTY[lvl].mult}</div>
            </button>
          ))}
        </div>
