...
const DIFFICULTY = {
  1: { label: "CADET", mult: 1, startSpeed: 0.85, maxSpeed: 1.6, rampRate: 0.0006 },
  2: { label: "EASY", mult: 1.2, startSpeed: 1.1, maxSpeed: 2.0, rampRate: 0.0009 },
  3: { label: "MEDIUM", mult: 1.45, startSpeed: 1.3, maxSpeed: 2.4, rampRate: 0.0012 },
  4: { label: "HARD", mult: 1.75, startSpeed: 1.55, maxSpeed: 2.85, rampRate: 0.0016 },
  5: { label: "ACE", mult: 2.1, startSpeed: 1.8, maxSpeed: 3.3, rampRate: 0.002 },
  6: { label: "LEGEND", mult: 2.5, startSpeed: 2.1, maxSpeed: 3.9, rampRate: 0.0026 },
};
