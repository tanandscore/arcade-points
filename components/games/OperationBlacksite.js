...
const WEAPONS = {
  ...
  pistol: { name: "Viper Pistol", damage: 24, fireRate: 340, spread: 0.05, mag: 12, reload: 1100, price: 0, tracer: "#ffe14d", heatRate: 0.1, recoilDrift: 0.015 },
  smg: { name: "Ranger SMG", damage: 16, fireRate: 95, spread: 0.1, mag: 30, reload: 1500, price: 900, tracer: "#3ee6e0", heatRate: 0.22, recoilDrift: -0.045 },
  rifle: { name: "Phantom Rifle", damage: 32, fireRate: 150, spread: 0.055, mag: 25, reload: 1800, price: 2200, tracer: "#ff3ea5", heatRate: 0.16, recoilDrift: 0.035 },
};
