...
export default function BuyButton({ slug, gameName, accessType, priceDisplay, planName = "Power Pass" }) {
  ...
  async function handleClick() {
    ...
    const options = {
      key: data.keyId,
      name: "Tap & Score",
      description: isSubscription ? `${planName} — monthly` : `Unlock ${gameName}`,
      theme: { color: "#ffb703" },
