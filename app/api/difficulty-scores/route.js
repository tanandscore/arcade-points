...
export async function POST(request) {
  ...
  // A real, pre-existing gap fixed here: this route never called
  // increment_lifetime_points at all, meaning every difficulty-tiered
  // game (every flagship game, played either normally or through the
  // tournament page — both paths hit this same endpoint) never
  // contributed to a player's lifetime score. Matches the exact same
  // pattern /api/scores already uses: accumulates on every finish,
  // not just new personal bests, since it's a separate, ever-growing
  // counter powering the Hall of Fame.
