...
export async function PATCH(request, { params }) {
  ...
  if (typeof body.show_in_winners_list === "boolean") updates.show_in_winners_list = body.show_in_winners_list;
  if (typeof body.require_tournament_entry === "boolean") updates.require_tournament_entry = body.require_tournament_entry;
