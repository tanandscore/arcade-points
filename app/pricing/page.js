...
// Deliberately public — no auth check, no redirect. Paddle (and most
...
export default async function PricingPage() {
  ...
  const powerPassPrice = powerPassGames[0]?.subscriptionPlanPaddlePriceDisplayMonthly || null;
  const legendPassPrice = legendPassGames[0]?.subscriptionPlanPaddlePriceDisplayMonthly || null;
    ...
    <div className="min-h-screen bg-bgDeep text-textLight">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-textDim text-sm mb-10">
          ...
          <Link href="/refund-policy" className="text-accentCyan underline">Refund & Cancellation Policy</Link>. Payments are processed securely via Paddle.
        </p>
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          <div className="rounded-xl border border-lineColor bg-bgPanel p-6 flex flex-col">
            ...
            <p className="font-pixel text-2xl text-accentMagenta mb-4">Free</p>
          ...
          <div className="rounded-xl border-2 p-6 flex flex-col bg-bgPanel" style={{ borderColor: "#ffb703" }}>
            ...
            <p className="font-mono text-[10px] text-accentCyan mb-3">✨ Includes animated avatars, premium themes, and exclusive cosmetics for your profile.</p>
