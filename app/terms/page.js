      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-textDim leading-relaxed">
          ...
          <section>
            ...
            <p>One-time game purchases and monthly subscriptions are processed securely via Paddle. See our <Link href="/refund-policy" className="text-accentCyan underline">Refund & Cancellation Policy</Link> for details on refunds and cancelling a subscription.</p>
          </section>
