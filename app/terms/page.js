      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-textDim leading-relaxed">
          <section>
            ...
            <p>By creating an account or using Tap & Score ("the Service", "we", "us"), you agree to these Terms of Service. If you do not agree, please do not use the Service. Tap & Score (tapandscore.com) is owned and operated by Rupam Sarmah, a sole proprietor.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">One-time game purchases and monthly subscriptions are processed securely via Paddle. See our <Link href="/refund-policy" className="text-accentCyan underline">Refund & Cancellation Policy</Link> for details on refunds and cancelling a subscription.</p>
          ...
          <section>
            ...
            <p>Questions about these Terms? Email us at <a href="mailto:support@tapandscore.com" className="text-accentCyan underline">support@tapandscore.com</a> or call <a href="tel:+917399372232" className="text-accentCyan underline">+91 73993 72232</a>. See our <Link href="/contact" className="text-accentCyan underline">Contact page</Link> for more ways to reach us.</p>
          </section>
        </div>
      </div>
    </div>
