        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <div className="relative w-full sm:w-auto">
              <span
                className="absolute -top-2.5 -right-2.5 z-10 font-pixel text-[8px] px-2 py-1 rounded-full text-bgDeep shadow-lg"
              ...
              <Link
                href="/signup"
                className="block font-pixel text-[11px] px-8 py-4 rounded-md bg-accentCyan text-bgDeep w-full sm:w-auto text-center"
              >
                PLAY FREE ▸
              </Link>
            </div>
