  ...
  return (
    <div className="rounded-xl border border-lineColor p-6 bg-bgPanel">
      ...
      <p className="text-textDim text-xs mb-4">
        Get 30 days of free Premium access for every friend who signs up with your link.
      </p>
      {bonusActive && (
        <p className="text-[11px] text-accentCyan mb-4">
          🎁 You have free Premium access until {new Date(bonusUntil).toLocaleDateString()}.
        </p>
      )}
      {link ? (
