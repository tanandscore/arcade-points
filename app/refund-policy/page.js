      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-textDim leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-2">Premium is billed automatically every month until you cancel. You can cancel anytime from <Link href="/account" className="text-accentCyan underline">Account Settings</Link> — you'll keep full access until the end of the billing period you've already paid for, and you won't be charged again after that. We don't provide partial refunds for the remaining days of a period you cancel mid-cycle.</p>
          </section>

          <section>
            <h2 className="font-pixel text-[11px] text-accentCyan mb-3">PAYMENT ISSUES</h2>
            <p>If you were charged incorrectly or a payment failed but you were still billed, contact us with your payment reference (visible in your Razorpay confirmation email) and we'll investigate and refund where appropriate.</p>
          </section>

          <section>
            <h2 className="font-pixel text-[11px] text-accentAmber mb-3">HOW REFUNDS ARE PROCESSED</h2>
            <p>Approved refunds are issued back to your original payment method via Razorpay, and typically reflect within 5–7 business days depending on your bank.</p>
          </section>
