      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-textDim leading-relaxed">
          ...
          <section>
            ...
            <p>If you were charged incorrectly or a payment failed but you were still billed, contact us with your payment reference (visible in your Paddle confirmation email) and we'll investigate and refund where appropriate.</p>
          </section>

          <section>
            <h2 className="font-pixel text-[11px] text-accentAmber mb-3">HOW REFUNDS ARE PROCESSED</h2>
            <p>Approved refunds are issued back to your original payment method via Paddle, and typically reflect within 3–5 business days depending on your bank.</p>
          </section>

          <section>
            <h2 className="font-pixel text-[11px] text-accentCyan mb-3">CONTACT</h2>
            <p>Questions about a charge or cancellation? Email <a href="mailto:support@tapandscore.com" className="text-accentCyan underline">support@tapandscore.com</a> or call <a href="tel:+917399372232" className="text-accentCyan underline">+91 73993 72232</a>.</p>
          </section>
        </div>
      </div>
    </div>
