      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-textDim leading-relaxed">
          <section>
            ...
            <p>When you create an account, we collect your email address, a username you choose, and (optionally) your country. As you play, we store your game scores and leaderboard rankings. If you make a purchase or subscribe, payment is handled entirely by PayU — we never see or store your card, UPI, or bank details.</p>
          </section>
          ...
          <section>
            ...
            <p>We use Supabase to host our database and handle account logins, and PayU to process payments. Both only receive the data necessary to provide their service to us — for example, PayU receives your payment details directly; we never do.</p>
          </section>
