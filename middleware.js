  ...
  if (!alwaysAllowed) {
    ...
    if (settings?.maintenance_mode) {
      ...
      if (!admin) {
        ...
        // Carried through so the maintenance page can send the
        // person right back to what they were doing once maintenance
        // ends, rather than dumping everyone at the dashboard.
